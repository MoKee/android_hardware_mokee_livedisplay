...
static jint org_mokee_hardware_LiveDisplayVendorImpl_getSupportedFeatures(
        JNIEnv* env __unused, jclass thiz __unused)
{
    return (jint) LiveDisplay::getInstance().getSupportedFeatures();
}

static jboolean org_mokee_hardware_LiveDisplayVendorImpl_isAdaptiveBacklightEnabled(
        JNIEnv* env __unused, jclass thiz __unused)
{
    return LiveDisplay::getInstance().isAdaptiveBacklightEnabled();
}

static jboolean org_mokee_hardware_LiveDisplayVendorImpl_setAdaptiveBacklightEnabled(
...
static jobjectArray org_mokee_hardware_LiveDisplayVendorImpl_getDisplayModes(
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getCurrentDisplayMode(
        JNIEnv* env, jclass thiz __unused)
{
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getDefaultDisplayMode(
        JNIEnv* env, jclass thiz __unused)
{
    return displayModeToObject(env,
...
static jboolean org_mokee_hardware_LiveDisplayVendorImpl_setDisplayMode(
...
static jboolean org_mokee_hardware_LiveDisplayVendorImpl_isOutdoorModeEnabled(
        JNIEnv* env __unused, jclass thiz __unused)
{
    return LiveDisplay::getInstance().isOutdoorModeEnabled();
}

static jboolean org_mokee_hardware_LiveDisplayVendorImpl_setOutdoorModeEnabled(
        JNIEnv* env __unused, jclass thiz __unused, jboolean enabled)
{
    return LiveDisplay::getInstance().setOutdoorModeEnabled(enabled) == OK;
}

static jobject org_mokee_hardware_LiveDisplayVendorImpl_getColorBalanceRange(
        JNIEnv* env __unused, jclass thiz __unused)
{
    Range range;
...
static jint org_mokee_hardware_LiveDisplayVendorImpl_getColorBalance(
        JNIEnv* env __unused, jclass thiz __unused)
{
    return LiveDisplay::getInstance().getColorBalance();
}

static jboolean org_mokee_hardware_LiveDisplayVendorImpl_setColorBalance(
        JNIEnv* env __unused, jclass thiz __unused, jint value)
{
    return LiveDisplay::getInstance().setColorBalance(value) == OK;
}

static jboolean org_mokee_hardware_LiveDisplayVendorImpl_setPictureAdjustment(
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getPictureAdjustment(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSIC hsic;
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getDefaultPictureAdjustment(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSIC hsic;
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getPictureAdjustmentRanges(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSICRanges ranges;
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getHueRange(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSICRanges ranges;
    if (LiveDisplay::getInstance().getPictureAdjustmentRanges(ranges) == OK) {
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getSaturationRange(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSICRanges ranges;
    if (LiveDisplay::getInstance().getPictureAdjustmentRanges(ranges) == OK) {
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getIntensityRange(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSICRanges ranges;
    if (LiveDisplay::getInstance().getPictureAdjustmentRanges(ranges) == OK) {
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getContrastRange(
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSICRanges ranges;
    if (LiveDisplay::getInstance().getPictureAdjustmentRanges(ranges) == OK) {
...
static jobject org_mokee_hardware_LiveDisplayVendorImpl_getSaturationThresholdRange (
        JNIEnv* env __unused, jclass thiz __unused)
{
    HSICRanges ranges;
    if (LiveDisplay::getInstance().getPictureAdjustmentRanges(ranges) == OK) {
...
static JNINativeMethod gLiveDisplayVendorImplMethods[] = {
    { "native_getSupportedFeatures",
        "()I",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getSupportedFeatures },
    { "native_isAdaptiveBacklightEnabled",
        "()Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_isAdaptiveBacklightEnabled },
    { "native_setAdaptiveBacklightEnabled",
        "(Z)Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_setAdaptiveBacklightEnabled },
    { "native_getDisplayModes",
        "()[Lmokee/hardware/DisplayMode;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getDisplayModes },
    { "native_getCurrentDisplayMode",
        "()Lmokee/hardware/DisplayMode;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getCurrentDisplayMode },
    { "native_getDefaultDisplayMode",
        "()Lmokee/hardware/DisplayMode;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getDefaultDisplayMode },
    { "native_setDisplayMode",
        "(Lmokee/hardware/DisplayMode;Z)Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_setDisplayMode },
    { "native_isOutdoorModeEnabled",
        "()Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_isOutdoorModeEnabled },
    { "native_setOutdoorModeEnabled",
        "(Z)Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_setOutdoorModeEnabled },
    { "native_getColorBalanceRange",
        "()Landroid/util/Range;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getColorBalanceRange },
    { "native_getColorBalance",
        "()I",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getColorBalance },
    { "native_setColorBalance",
        "(I)Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_setColorBalance },
    { "native_setPictureAdjustment",
        "(Lmokee/hardware/HSIC;)Z",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_setPictureAdjustment },
    { "native_getPictureAdjustment",
        "()Lmokee/hardware/HSIC;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getPictureAdjustment },
    { "native_getDefaultPictureAdjustment",
        "()Lmokee/hardware/HSIC;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getDefaultPictureAdjustment },
    { "native_getHueRange",
        "()Landroid/util/Range;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getHueRange },
    { "native_getSaturationRange",
        "()Landroid/util/Range;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getSaturationRange },
    { "native_getIntensityRange",
        "()Landroid/util/Range;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getIntensityRange },
    { "native_getContrastRange",
        "()Landroid/util/Range;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getContrastRange },
    { "native_getSaturationThresholdRange",
        "()Landroid/util/Range;",
        (void *)org_mokee_hardware_LiveDisplayVendorImpl_getSaturationThresholdRange },
};


static int register_org_mokee_hardware_LiveDisplayVendorImpl(JNIEnv *env)
{
    FIND_CLASS(gDisplayModeClass.clazz,
            "mokee/hardware/DisplayMode");
    ...
    int rc = jniRegisterNativeMethods(env,
            "org/mokee/hardware/LiveDisplayVendorImpl",
...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved __unused)
{
    ...
    register_org_mokee_hardware_LiveDisplayVendorImpl(env);
